...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="EraLedger — Sid Meier&apos;s Civilization VII — Eras" width="64" height="64">
<h1>EraLedger — Sid Meier&apos;s Civilization VII — Eras</h1>
</div>

独立的项目设计文档，适用对象： **Sid Meier's Civilization VII**。
...
- **时代过渡说明** (Age transition notes) — 规划模块，尚未实现。
- **聚落经济比较** (Settlement economy comparisons) — 规划模块，尚未实现。
- **规则集测试日志** (Ruleset test journal) — 规划模块，尚未实现。
...
| 字段 | 内容 |
|---|---|
| 适用对象 | Sid Meier's Civilization VII |
| 类别 | 本地游戏场景规格 |
| 输入 | 手工记录或用户授权的本地导出 |
| 计划输出 | 时代过渡说明 |
| 兼容性 | 未验证；未声明支持任何具体版本 |
